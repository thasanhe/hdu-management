...
class RoutineParameters extends StatefulWidget {
  final Patient patient;
  const RoutineParameters({Key? key, required this.patient}) : super(key: key);
  @override
  _RoutineParametersState createState() => _RoutineParametersState();
}

class _RoutineParametersState extends State<RoutineParameters> {
